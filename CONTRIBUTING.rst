...
pychromatic could always use more documentation, whether as part of the
official pychromatic docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
Ready to contribute? Here's how to set up `pychromatic` for local development.

1. Fork the `pychromatic` repo on GitHub.
