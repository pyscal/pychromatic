#!/usr/bin/env python
#
# pychromatic documentation build configuration file, created by
...
man_pages = [(root_doc, "pychromatic", "pychromatic Documentation", [author], 1)]
